...
public class ExperiencePatchDTO
{
    ...
    [StringLength(150, ErrorMessage = "El nombre de la experiencia no puede superar los 150 caracteres")]
    public string? NameExperiences { get; set; }

    [DataType(DataType.Date)]
    public DateTime? Developmenttime { get; set; }

    [StringLength(100, ErrorMessage = "El nombre del líder no puede superar los 100 caracteres")]
    ...
    // Institution
    [StringLength(120, ErrorMessage = "El nombre de la institución no puede superar los 120 caracteres")]
    public string? Name { get; set; }

    [StringLength(80, ErrorMessage = "El departamento no puede superar los 80 caracteres")]
    public string? Department { get; set; }

    [StringLength(80, ErrorMessage = "El municipio no puede superar los 80 caracteres")]
    public string? Municipality { get; set; }

    [StringLength(20, ErrorMessage = "El código DANE no puede superar los 20 caracteres")]
